...
export default function Index() {
  ...
  return (
    <>
      ...
      Merhaba Web-siteme Hoşgeldiniz Kurulumuna daha yeni Başladım Sizce Nasıl Olmuş Geliştirmeye Devam Edeceğim DAHA DENEME.
	  </p>
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
  
            <Link href={"XD EKLENECEK"}>
              <a
                className={
...
Vote DENEME</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            <p className="text-white text-4xl font-bold" dangerouslySetInnerHTML={{ __html:"DENEME" }} />
            <p className="text-white text-md font-medium text-gray-500/75" dangerouslySetInnerHTML={{ __html: "Merhaba Web-siteme Hoşgeldiniz Kurulumuna daha yeni Başladım Sizce Nasıl Olmuş Geliştirmeye Devam Edeceğim DAHA DENEME." }}/>
            <a href="https://discord.com/api/oauth2/authorize?client_id=774043716797071371&permissions=277028620608&scope=bot%20applications.commands" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
              <i className="fab fa-discord mr-2" />Invite DENEME
            </a>
          </div>
          ...
          <div className="col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <div className="text-white">
                  ...
                  <p className="text-gray-500 line-clamp-4">Sunucunuza özel hızlı ve kişiselleştirilebilen ayarlarla DENEME size EGLENCENIZI keyfini doyasıya yaşatıyor.</p>
                </div>
              </div>
              <div>
                <div className="text-white">
